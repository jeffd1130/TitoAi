...
|-----|-------|-------|--------|
| D-3 | Asset prep | Jeff | Gather S1 photo + S4 Codex screenshot for carousel; no recording needed |
...
- S1: hook (photo background) · S2: problem · S3: prompt · S4: Codex output (screenshot) · S5: CTA
...
- Real prompt + real Codex output in S3/S4
...
content/
  2026-W22/
    01-mon-ai-tip/
      raw/          ← carousel assets: S1 photo + S4 Codex screenshot (D-3)
...
Primary media source: **`/Users/jeff/Documents/Codex/TItoAi/Videos/`**
...
- **GitHub** — repo `jeffd1130/TitoAi` (main branch). Auto-push hook in `.Codex/settings.json` fires on Write/Edit when Codex is opened from this project directory.
...
> ⚠️ **CLI limitation:** Canva import/create/merge tools (`import-design-from-url`, `create_new_design`, `modify_existing_design`) are NOT available in Codex CLI. They only work in **Codex.ai web**. Step 3 below must be done there. Steps 1–2 can run from CLI as normal.
...
| W29 Wed | `DAHPbFUIlGo` | "Resume mo? Codex ang Gagawa — VA Demo" · 5 slides · edit: `https://www.canva.com/d/NF_8BtbZrObCg78` · all slides re-rendered with logo · no Maria |
...
| W31 Wed | `DAHQkBdVE5E` | "Proposal sa Kliyente, Codex ang Gagawa" · Freelancer persona · 5 slides · edit: `https://www.canva.com/d/ZtQ24Mkd0S1e9O6` |
...
| W27 ⭐ | Jun 29–Jul 5 | July na! Dalawang Feature (Codex Projects + Gemini Deep Research) ✅ | **Codex Projects — I-Setup Natin ang Iyong Trabaho Space** ✅ posted Jul 1 | Ang Taong Nagsimula Kahapon — May Kalamangan Na · drops Jul 3 7 PM ✅ ready |
...
| W29 | Jul 13–19 | Email Drafting — Hayaan ang AI ✅ posted Jul 14 | Resume at Cover Letter — Codex ang Gagawa · VA · carousel fixed · ✅ posted Jul 16 | **Story S1E2** — Ang Restaurant sa Clark at ang Social Media na Ginawa Namin · script + captions ready · drops Jul 18 7 PM |
| W30 | Jul 20–26 | Tanungin ang AI — Mas Mabilis Pa sa Google ✅ posted Jul 22 | Alinman Ka Man — Hayaan ang Codex ✅ posted Jul 23 | **Story S1E3** — Tatay. Analyst. Trainer. Sa Iisang Araw. ✅ posted Jul 24 |
| W31 | Jul 27–Aug 2 | Isang Prompt. Sampung Email. — VA Inbox Carousel ✅ posted Jul 28 (260 views) | Proposal sa Kliyente, Codex ang Gagawa — Freelancer Carousel ✅ posted Jul 30 (213 views) | **Story S1E4** — Ang BJJ Champion at ang Marketing Analyst na Nasa Manila (Season 1 finale) ✅ posted Aug 1 (169 views) · boost placement unconfirmed |
| W32 | Aug 3–9 | Nasa Data World Ka. May Side Hustle Nang Naghihintay. — Data Analyst · DAHRNqXlTbc ✅ posted Aug 3 | 30 Bata. 30 Reports. 3 Minuto kay Codex. — Guro · DAHRYiEjngw ✅ posted Aug 5 | S2E1 — Iba't Ibang Kliyente. Iisang AI. Kaya ng Lahat. ✅ posted Aug 7 |
| W33 | Aug 10–16 | BPO ka? Codex ang Bagong Teammate Mo. — BPO · DAHR158OONs · draft, drops 8 PM PHT | Negosyante ka? Codex ang Susulat ng Posts Mo. — slides + captions built, Canva pending | S2E2 — Ang Unang Araw na Nagturo Ako ng AI sa Ibang Tao · script + captions ready |
...
| Ep | Week | Title | Story |
|----|------|-------|-------|
| S1E1 | W28 Fri Jul 11 | Dalawang Linggo. Isang Website. At Tatay Pa Rin Ako. | Jeff builds client website in 20-min stolen moments while doing dad duties. Gemini for site outline → Codex for copy. Script + captions ready. |
| S1E2 | W29 Fri Jul 18 | Ang Restaurant sa Clark at ang Social Media na Ginawa Namin | Clark restaurant launch — Jeff did the social media campaign with Codex (captions/tone) + Gemini (content planning). Script + captions ready. |
...
**CJEF Day 1 AI Training (Jul 6, 2026):** First corporate/school training conducted. ~12 participants — guro, admin, school directors. Tools: Codex + Gemini (free). Full day. Certificate ceremony. Assets in `/Users/jeff/Documents/Codex/TitoAI-Training/CJEF_Day1/` — 10 photos + 3 videos (~30s each). Special post published Jul 6 with "TRAINING" CTA for lead gen. Slides: `/Users/jeff/Documents/Codex/TitoAI-Training/slides/CJF_AllRoles_Slides.html`.
...
**Routine health check (Jul 9, 2026):** `reports/2026-07-09-health-check.md` — repo/automation normal. IG: 70 followers, 90-day views 2,152. TikTok: 146 followers, last-7-days views down 37.8% WoW but profile views +200% and branded search queries appearing ("tito ai story," "Codex resume"). Flag: the "Codex Projects" script was duplicate-posted 4x (Jun 30–Jul 3) despite the no-duplicate rule, and its best result was an **unpinned** copy (678 views/24 likes) — first case where pinning didn't win. Treat as a one-off until more data confirms; don't revise the pin-first rule yet. W28 Wed boost post ("Gemini sa Gmail," pinned Jul 8) at only 195 views ~1 day in — recheck after 48–72h.
...
**Weekly check & balance (Jul 27, 2026):** `reports/2026-07-27-weekly-checkbalance.md` — automation/repo health normal; found and committed a ~6-day-old uncommitted backlog (an exec-summary file rename + last week's own Jul 22 health-check report, which is why that report wasn't logged here until now). Social-health pull failed again (3 of the last 4 cycles) — Codex in Chrome unavailable and `web_fetch` can't render either JS-heavy profile page. `schedule.json` was stale (still showed W30 Wed/Fri as TBD and all of W31 as TBD despite scripts/captions/carousels already existing in the repo) — synced to reflect actual production status. **Applying the Jul 22 story-boost insight:** recommended this week's boost budget go to Fri S1E4 (Season 1 finale) rather than the Wed carousel, and added posting-insight banners to both `docs/W31-wed-captions.html` and `docs/W31-fri-captions.html` reflecting that. Priority for next cycle: get a live account pull (way overdue) and confirm whether W30 Wed/Fri and the S1E4 boost actually went out.
...
**Primary tools featured in all content:** Codex (Codex.ai) + Gemini (gemini.google.com) — both free. Never reference paid tools.
...
| `tito-record.py` | D-3 asset prep reminder: gather S1 photo + S4 Codex screenshot for carousel | 9:00 AM — Fri / Sun / Tue |
...
do routine health check and ensure that claude code runs and pushes info and content
 always check health of Social Media Accounts
IG - https://www.instagram.com/tito.aiph/
TikTok - https://www.tiktok.com/@tito.aiph
