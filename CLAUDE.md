...
**Current/Next/Upcoming weeks (as of Sep 7, 2026):**
| Role | Week | Dates |
|------|------|-------|
| Current | W36 | Aug 31–Sep 6 — all 3 posted: Mon Gemini-reviewer carousel (212 views), Wed grounded-PDF-prompting carousel (**590 views, unpinned — best unpinned result in channel history**), Fri real-seminar-testimony carousel (260 views). None got the rotating TikTok pin slot, which is still held by the weak Aug 29 undocumented post (133 views) |
| Next | W37 | Sep 7–13 — **URGENT: not yet planned at all**, no script/captions/Canva for any slot; Monday's 8 PM PHT drop is same-day as of this check. CJEF proof story (`docs/scripts/w34-fri-script.html`, CTA Comment GUSTO) still **unproduced for a 4th cycle** |
| Upcoming | W38 | Sep 14–20 — not yet planned |
